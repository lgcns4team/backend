...
@Builder
public class ManagerOrderItemOptionEntity {
    ...
    private ManagerOrderItemEntity orderItem;
    ...
    private ManagerOrderItemEntity optionItem;
     ...
     * 편의 메서드: OrderItem 설정
     */
    public void setOrderItem(ManagerOrderItemEntity orderItem) {
